...
#    read_only_warning: "Note: you can't save any edits here, because you're not logged in as an admin."
  ...
  article:
    edit_btn_preview: "Попередній перегляд"
...
#    helpful_ambassadors: "Our Helpful Ambassadors:"
  ...
  classes:
    ...
    artisan_title_description: "(Дизайнер рівнів)"
    adventurer_title: "Авантюрист"
    adventurer_title_description: "(Тестер рівнів)"
    scribe_title: "Писар"
  ...
  ladder:
    ...
    battle_as: "Battle as "
    summary_your: "Your "
    summary_matches: "Матчі - "
    summary_wins: " Перемог, "
    summary_losses: " Програшів"
    ...
    choose_opponent: "Виберіть супротивника"
    tutorial_play: "Play Tutorial"
    tutorial_recommended: "Recommended if you've never played before"
    tutorial_skip: "Пропустити інструкцію"
    tutorial_not_sure: "Not sure what's going on?"
    tutorial_play_first: "Play the Tutorial first."
    simple_ai: "Простий Штучний Інтелект"
    warmup: "Warmup"
    vs: "проти"

  multiplayer_launch:
    introducing_dungeon_arena: "Introducing Dungeon Arena"
    new_way: "Новий вид змагання між кодерами"
    to_battle: "До бою, розробники!"
    ...
    create_worlds: "і створюйте свої слова."
    javascript_rusty: "JavaScript a bit rusty? Don't worry; there's a"
    tutorial: "Інструкція"
    new_to_programming: "Ви новачок у програмуванні? Почніть кампанію для новачків, щоб підняти свій рівень."
    so_ready: "Я готовий"
  loading_error:
    could_not_load: "Помилка завантаження даних з серверу"
    connection_failure: "Проблема зі з'єднанням."
    unauthorized: "Ви маєте увійти. Можливо, ви вимкнули cookies?"
    forbidden: "Ви не маєте достатньо прав."
  ...
  resources:
    ...
    gplus_friends: "Друзі Google+ "
    gplus_friend_sessions: "Сесії друзів з Google+"
    leaderboard: "Рекорди"
